...
import 'package:hrh_pos/presentation/settings/pages/manage_printer_page.dart';
import 'package:hrh_pos/presentation/settings/pages/sync_data_pages.dart';
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ListTile(
                      contentPadding: const EdgeInsets.all(12.0),
                      leading: Assets.icons.kelolaPrinter.svg(),
                      title: const Text('Sinkrinisasi Data'),
